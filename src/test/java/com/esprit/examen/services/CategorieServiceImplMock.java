...
public class CategorieServiceImplMock {
	...
	public void getUsersTest() {
		Mockito.when(categorieProduitRepository.findAll()).thenReturn(Stream.of(new CategorieProduit("cat2", "categorie 2"), new CategorieProduit("cat2", "categorie 3")).collect(Collectors.toList()));
